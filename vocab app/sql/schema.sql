...
CREATE TABLE IF NOT EXISTS wm_words (
    ...
    bank_code VARCHAR(40) NOT NULL DEFAULT 'high_school',
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uniq_bank_word (bank_code, word),
    KEY idx_bank_code (bank_code),
    CONSTRAINT fk_wm_words_bank FOREIGN KEY (bank_code) REFERENCES wm_word_banks(code) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
